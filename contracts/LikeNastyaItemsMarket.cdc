...
import LikeNastyaItems from "./LikeNastyaItems.cdc"
import FungibleToken from 0x9a0766d93b6608b7
import NonFungibleToken from 0x631e88ae7f1d7c20

/*
    This is a simple LikeNastyaItems initial sale contract for the DApp to use
    in order to list and sell LikeNastyaItems.
...
pub contract LikeNastyaItemsMarket {
    // SaleOffer events.
    //
    ...
    // SaleOffer
    // A LikeNastyaItems NFT being offered to sale for a set fee paid in Flow.
    //
    pub resource SaleOffer: SaleOfferPublicView {
        ...
        // The LikeNastyaItems NFT ID for sale.
        pub let itemID: UInt64
        ...
        access(self) let sellerItemProvider: Capability<&LikeNastyaItems.Collection{NonFungibleToken.Provider}>
        ...
        // the LikeNastyaItems NFT will be placed in their LikeNastyaItems.Collection .
        //
        pub fun accept(
            buyerCollection: &LikeNastyaItems.Collection{NonFungibleToken.Receiver},
        ...
        // to transfer the LikeNastyaItems NFT and the capability to receive Flow in payment.
        //
        init(
            sellerItemProvider: Capability<&LikeNastyaItems.Collection{NonFungibleToken.Provider}>,
            itemID: UInt64,
            typeID: UInt64,
    ...
    pub resource interface CollectionManager {
        pub fun insert(offer: @LikeNastyaItemsMarket.SaleOffer)
    ...
    pub resource Collection : CollectionManager, CollectionPurchaser, CollectionPublic {
        ...
        //   2. LikeNastyaItems.Withdraw
        //   3. LikeNastyaItems.Deposit
    ...
    init () {
        ...
        self.CollectionStoragePath = /storage/LikeNastyaItemsMarketCollection008
        self.CollectionPublicPath = /public/LikeNastyaItemsMarketCollection008
    }
}